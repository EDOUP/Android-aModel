...
public class Fragment_03_ListViewAdapter extends BaseAdapter{

	private LayoutInflater layoutInflater;
	private List<Map<String,Object>> dataList;

	public Fragment_03_ListViewAdapter(Context context) {
		super();
	...
	public View getView(int position, View convertview, ViewGroup viewGroup) {
		...
		View view;
		if(convertview==null)
			view=layoutInflater.inflate(R.layout.fragment_left_03_item, null);
		else
			view=convertview;
		
		/*获取ListView的Item上各View的对象*/
		TextView title=(TextView)view.findViewById(R.id.f03_item_text);
